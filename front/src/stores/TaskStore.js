...
export const useTaskStore = defineStore('TaskStore', {
    ...
    actions: {
        ...
        updateTask(task){
            ...
            .then((data) => {
                let taskForUpdate = this.tasks.find(t => t.id === data.id)
                console.log(data)
                taskForUpdate.importance= data.importance
                taskForUpdate.title = data.title
                taskForUpdate.deadline = data.deadline
            } )
        },
